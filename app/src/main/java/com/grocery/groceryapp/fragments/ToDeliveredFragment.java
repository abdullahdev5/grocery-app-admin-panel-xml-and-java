...
import com.grocery.groceryapp.databinding.FragmentToDeliveredBinding;
...
public class ToDeliveredFragment extends Fragment {
    ...
    FragmentToDeliveredBinding binding;
    FirebaseAuth auth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentToDeliveredBinding.inflate(inflater, container, false);
        ...
        binding.rvToDelivered.setHasFixedSize(true);
        binding.rvToDelivered.setLayoutManager(new LinearLayoutManager(getContext()));
        buyedProductsAdapter = new BuyedProductsAdapter(getContext(), buyedProductsModelArrayList);
        binding.rvToDelivered.setAdapter(buyedProductsAdapter);
        CheckValidationAndThenAddToDeliveredProducts();
    ...
    private void CheckValidationAndThenAddToDeliveredProducts() {
    ...
    private void AddToDeliveredProducts() {
